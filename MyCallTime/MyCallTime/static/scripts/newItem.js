$(document).ready(function () {
    $('#addTalent').click(function()
    {
        ...
        newHtml += '<div><input id="talent-' + index + '-name" name="talent-' + index + '-name" type="text" value=""></div></div><div class="start_time col-md-4">'
        newHtml += '<label for="talent-' + index + '-start_time">start_time</label><div><input id="talent-' + index + '-start_time" name="talent-' + index + '-start_time" type="time" value=""></div></div>'
        newHtml += '</div><div class="row"><div class="agency col-md-4"><label for="talent-' + index + '-agency">agency</label><div><input id="talent-' + index + '-agency" name="talent-' + index + '-agency" type="text" value=""></div></div>'
        newHtml += '</div><div class="row"><div class="notes col-md-4"><label for="talent-' + index + '-notes">notes</label><div><input id="talent-' + index + '-notes" name="talent-0-notes" type="text" value=""></div></div></div></li>'
